...
export default function Todolisttwo()
{
   ...
   let addNewTask = () =>{
        setTodos([...todos,newTodo]) ;          //new line //bhai sahab yeka line ne purn change zla smjl ka
        setNewTodo("");                   // bhai sahb yeka line ne bhai te nav je takt hoto box madhe te na gayh hotay smjl ka 
